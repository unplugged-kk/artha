 ...
 * `schema.sql`, the regex in `CreatePatDto`, the `artha:`-prefixed list the
 ...
 * presents them resource-prefixed (`artha:read`) and `OAuthProviderService`
...
export const MCP_SCOPE_PREFIX = "artha:";
