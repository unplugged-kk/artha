...
//
// The wire shape of `GET /investments/performance/securities/:id/rolling-returns`.
// `docs/specs/fund-rolling-returns.md` is the contract, and
// `backend/src/securities/performance-comparison.types.ts` is the half of it
// these mirror. Every figure is the server's; the client computes none.
